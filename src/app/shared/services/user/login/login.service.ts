...
export class LoginService {
  ...
  googleLogin(): Promise<firebase.auth.UserCredential> {
    /*   return this.googlePlus.login({
      ...
      'webClientId': 'NEED-NEW-KEY', // optional clientId of your Web application from Credentials settings of your project - On Android, this MUST be included to get an idToken. On iOS, it is not required.
